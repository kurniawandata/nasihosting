...
echo " Version 1.0 Beta 14 - 20/06/2020                                ";
echo "=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=";
echo " Instalasi                                                       ";
...
echo " [11] Amankan dari PHP Shell, amankan dari deteksi ip asli saat  ";
echo "      cloudflare aktif, penyesuaian kapasitas untuk upload dan   ";
echo "      sebagainya                                                 ";
echo "=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=";
echo " Virtual host                                                    ";
...
echo ""
echo "Nasihosting for X-code v1.0 Beta 14 - Ubuntu Server"
