...
-------------------------
Semua instalasi sudah dilakukan otomatis dalam program, tapi untuk DNS managemen tetap dari luar, seperti untuk domain dengan panel domain, atau cloudflare jika ingin domain dan subdomain, semua ditambahkan secara manual (aktivasi).
